...
public:
   ...
   // FIXME: Might take this out of here as well
   virtual UInt64 getMegapageSize() const
   {
      return 0;
   }
   // virtual ParametricDramDirectoryMSI::TLB* getTLB() = 0;
   ...
   // virtual ParametricDramDirectoryMSI::PageTableWalker* getPTW() = 0;
   // Modeling
