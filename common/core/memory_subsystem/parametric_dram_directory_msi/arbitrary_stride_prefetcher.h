...
namespace ParametricDramDirectoryMSI
{
	...
	public:
		...
		ArbitraryStridePrefetcher(Core *_core, MemoryManager *_memory_manager, ShmemPerfModel *_shmem_perf_model, int table_size, int prefetch_threshold, bool extra_prefetch);
