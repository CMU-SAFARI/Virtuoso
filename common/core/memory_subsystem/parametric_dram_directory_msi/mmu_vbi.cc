...
// 	MemoryManagementUnitVBI::MemoryManagementUnitVBI(Core *_core, MemoryManager *_memory_manager, ShmemPerfModel *_shmem_perf_model) : MemoryManagementUnitBase(_core, _memory_manager, _shmem_perf_model),
// 																																	   core(_core),
...
// 	MemoryManagementUnitVBI::~MemoryManagementUnitVBI()
// 	{
// 		delete page_table;
// 		delete tlb_subsystem;
// 	}

// 	void MemoryManagementUnitVBI::instantiateRLB()
// 	{
...
// 	void MemoryManagementUnitVBI::instantiateRangeTable()
// 	{
...
// 	}
// 	void MemoryManagementUnitVBI::instantiatePageTable()
// 	{
...
// 	void MemoryManagementUnitVBI::instantiateTLBSubsystem()
// 	{
// 		tlb_subsystem = new TLBHierarchy("tlb_subsystem", core);
// 	}
// 	void MemoryManagementUnitVBI::registerMMUStats()
// 	{
...
// 	}
// 	void MemoryManagementUnitVBI::performAddressTranslationFrontend(IntPtr eip, IntPtr address, bool instruction, Core::lock_signal_t lock, bool modeled, bool count)
// 	{
...
// 		}
// 	}
// 	void MemoryManagementUnitVBI::performAddressTranslationBackend(IntPtr eip, IntPtr address, bool instruction, Core::lock_signal_t lock, bool modeled, bool count)
// 	{
// 		if (count)
...
// 				{
// 					tlb_block_info = tlbs[i][j]->lookup(address, time, count, lock);
...
// 							result = tlbs[i][j]->allocate(get<0>(evicted_translations[i - 1][k]), time, count, lock, get<1>(evicted_translations[i - 1][k]));
...
// 					result = tlbs[i][j]->allocate(address, time, count, lock, page_size);
// 					if (get<0>(result) == true)
// 					{
// 						evicted_translations[i].push_back(make_tuple(get<1>(result), get<2>(result)));
// 					}
...
// 	void MemoryManagementUnitVBI::discoverVMAs()
// 	{
