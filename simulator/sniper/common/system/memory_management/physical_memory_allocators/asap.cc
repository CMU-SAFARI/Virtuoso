...
// ASAPAllocator::ASAPAllocator(String name,
//                                                  int memory_size,
//                                                  int max_order,
//                                                  int kernel_size,
//                                                  String frag_type,
...
//  */
// bool ASAPAllocator::demote_page()
// {
...
//  */
// std::pair<UInt64, bool> ASAPAllocator::checkFor2MBAllocation(UInt64 address, UInt64 core_id)
// {
...
//  */
// std::pair<UInt64, UInt64> ASAPAllocator::allocate(UInt64 size, UInt64 address, UInt64 core_id, bool is_pagetable_allocation)
// {
// 	stats.total_allocations++;
// #ifdef DEBUG_ASAP
// 	log_file << "ASAPAllocator::allocate(" << size << ", " << address << ", " << core_id << ")" << std::endl;
// #endif
...
//  */
// UInt64 ASAPAllocator::givePageFast(UInt64 bytes, UInt64 address, UInt64 core_id)
// {
// #ifdef DEBUG_ASAP
// 	log_file << "ASAPAllocator::givePageFast(" << bytes << ", " << address << ", " << core_id << ")" << std::endl;
// #endif
...
//  */
// void ASAPAllocator::deallocate(UInt64 region_begin, UInt64 core_id)
// {
...
//  */
// std::vector<Range> ASAPAllocator::allocate_ranges(IntPtr start_va, IntPtr end_va, int app_id)
// {
...
//  */
// UInt64 ASAPAllocator::getFreePages() const
// {
// 	return buddy_allocator->getFreePages();
// }

// UInt64 ASAPAllocator::getTotalPages() const
// {
// 	return buddy_allocator->getTotalPages();
// }

// double ASAPAllocator::getLargePageRatio()
// {
// 	return buddy_allocator->getLargePageRatio();
// }

// double ASAPAllocator::getAverageSizeRatio()
// {
...
//  */
// void ASAPAllocator::fragment_memory()
// {
