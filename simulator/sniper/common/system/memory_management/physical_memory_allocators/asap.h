...
// class ASAPAllocator : public PhysicalMemoryAllocator
// {
// public:
//     ASAPAllocator(String name, int memory_size, int max_order, int kernel_size, String frag_type, float threshold_for_promotion);
//     ~ASAPAllocator();
...
//     virtual UInt64 handle_page_table_allocations(UInt64 index)
//     {
//         return 0;
//     }
