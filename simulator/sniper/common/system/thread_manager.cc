...
{
   #ifdef DEBUG_MANAGER
      std::cout << "ThreadManager::createThread: " << app_id << " " << creator_thread_id << std::endl;
   #endif   
...
{
   std::cout << "ThreadManager::onThreadExit: " << thread_id << std::endl;
   ScopedLock sl(m_thread_lock);
...
void ThreadManager::printInfo()
{
   ...
   for(int tid = 0; tid < m_thread_state.size();tid++){
      ...
      std::cout << "waiter:" <<  ts.waiter;
            
      std::string state_string;
      switch(ts.status) {
        case Core::RUNNING: state_string = "RUNNING"; break;
        case Core::INITIALIZING: state_string = "INITIALIZING"; break;
        case Core::STALLED: state_string = "STALLED"; break;
        case Core::SLEEPING: state_string = "SLEEPING"; break;
        case Core::WAKING_UP: state_string = "WAKING_UP"; break;
        case Core::IDLE: state_string = "IDLE"; break;
        case Core::BROKEN: state_string = "BROKEN"; break;
        default: state_string = "UNKNOWN_STATE"; break;
      }
      std::cout << ", status: " << state_string;

      if(ts.status == Core::STALLED){
         std::string stallreason_string;
         switch(ts.stalled_reason) {
            case STALL_UNSCHEDULED: stallreason_string = "STALL_UNSCHEDULED"; break;
            case STALL_BROKEN: stallreason_string = "STALL_BROKEN"; break;
            case STALL_JOIN: stallreason_string = "STALL_JOIN"; break;
            case STALL_MUTEX: stallreason_string = "STALL_MUTEX"; break;
            case STALL_COND: stallreason_string = "STALL_COND"; break;
            case STALL_BARRIER: stallreason_string = "STALL_BARRIER"; break;
            case STALL_FUTEX: stallreason_string = "STALL_FUTEX"; break;
            case STALL_PAUSE: stallreason_string = "STALL_PAUSE"; break;
            case STALL_SLEEP: stallreason_string = "STALL_SLEEP"; break;
            case STALL_SYSCALL: stallreason_string = "STALL_SYSCALL"; break;
            default: stallreason_string = "UNKNOWN_STALL_TYPE"; break;
         }
         std::cout << ", Stalled because: " << stallreason_string;
      }
