...
BarrierSyncClient::BarrierSyncClient(Core *core) : m_core(core),
                                                   m_num_outstanding(0)
{
   try
   {
...
void BarrierSyncClient::synchronize(SubsecondTime time, bool ignore_time, bool abort_func(void *), void *abort_arg)
{
